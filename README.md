...
- 真实 mutation 继续逐方法门禁。`saveProductDraft` 已接入本地 Node BFF，但 2026-08-21 真实 Smoke 在当前网关返回错误码 `22`（不合法 ApiName），因此默认 flag 已重新关闭；正式发布、商品更新、staging、production 和扩展商品写入也继续关闭，UI 没有自行开启入口。
