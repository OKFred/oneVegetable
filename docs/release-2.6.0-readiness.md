...
- ZIP 仍为 `artifacts/one-vegetable-v2.6.0-chrome-mv3.zip`，**986,558 字节**；SHA-256：`1c8a9541061b6a2999f13f06dda9039495a5b74001ba1e3b7bf2040571e64590`。它替换了下节 09-11 及先前 09-12 的同名候选，不能混用校验值。
