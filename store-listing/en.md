...
- Import and export gallery ZIPs up to 50 MiB with originals and an integrity manifest; uploads require confirmation. S3 folder mapping is available only in Web/BFF mode.
