...
- Manage credentials, S3 storage, connections, language, diagnostics and data in separate settings sections. Switching sections preserves unsaved input; import rules expand on demand.
