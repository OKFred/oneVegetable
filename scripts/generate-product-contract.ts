...
import { sharedJsonSource } from './lib/shared-json-codegen';
...
const shared = sharedJsonSource(capabilityMap);
const registry = `// Generated by scripts/generate-product-contract.ts. Do not edit.\nimport type { components } from './api';\n\nexport interface ProductCapabilityRequestMap {\n${definitions
  ...
  .join(
    '\n'
  )}\n}\n\n${shared.declarations}\nexport const PRODUCT_CAPABILITY_DEFINITIONS = ${shared.expression} as const;\n`;
