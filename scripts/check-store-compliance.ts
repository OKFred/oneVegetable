...
const privacyHtml = await readFile(resolve(root, 'store-listing/privacy/privacy.html'), 'utf8');
const privacyEnglishHtml = await readFile(resolve(root, 'store-listing/privacy/privacy-en.html'), 'utf8');
...
if (
  ...
  errors.push('store listing must disclose the exact reviewed product creation and gallery mutation set');
}
