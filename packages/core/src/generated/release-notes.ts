  ...
  releases: [
    {
      ...
      title: {
        'zh-CN': '图库任务与安全恢复（候选）',
        'en-US': 'Gallery tasks and safe recovery (candidate)'
      },
      summary: {
        'zh-CN': '开发候选，尚未上架。ZIP/S3 传输支持本机记录、暂停和手工恢复。',
        'en-US':
          'Development candidate, not yet published. Local ZIP/S3 task history, pause and manual recovery.'
      },
      source: 'release',
      githubUrl:
        'https://github.com/OKFred/oneVegetable/blob/codex/gallery-transfer-task-recovery/docs/release-2.6.0-readiness.md',
      compareUrl: null,
      changes: [
        {
          type: 'feature',
